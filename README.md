    ...
    <section>
      ...
      <header><a name="start"></a>
        ...
        <section class="stats1 ">
            ...
            <div class="study1">
                <img class="study" src="aleksei/h.jpg">
            </div>
...
<footer>
   <!--<div class="wrapper">
        ...
        <div class="footer-links">
            <div class="footer-links-ligo">
               <a href="https://www.instagram.com/yarik_m.y/" target="blank" title="www.instagram.com"> <img src="aleksei/imgonline-com-ua-convertU51NIVmkYh3B.svg"></a>
            </div>
            <div class="footer-link">
                <p>да блин, когда же это закончится?</p>
